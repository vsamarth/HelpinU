  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leadingWidth: 0,
        title: const Text('HelpinU', style: TextStyle(fontFamily: "Poppins", color: kTextColor, fontSize: 30,  fontWeight: FontWeight.bold),),
        actions: <Widget>[
        //add text
        Container(
            ...
            child : Row(
              children: [
                ...
                SizedBox(
                  ...
                  controller: TextEditingController()..text = "Description of organization",
